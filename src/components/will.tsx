            ...
            <div className="absolute inset-0 bg-[url('/Rectangle-11.svg')] bg-contain bg-center opacity-15" />
                <div className=" w-full block  lg:max-w-[85rem] md:max-w-[50rem]  mx-auto px-4 xl:pt-[1.5rem]  pb-40 h-screen isolate">
                    <div className="flex flex-col gap-8 justify-center items-center h-full">
                        <h2 className="text-7xl text-[#3A0517] font-birds">Babadele Ayomide Winnifred</h2>
                            <div className="flex items-center gap-8 text-5xl ">
                                <span className="font-birds text-[6rem] text-[#3A0517]">Will you officially be my</span>
                                <RotatingText
                        ...
                        <div className="flex gap-10 justify-center items-center">
                            <button className="w-[12rem] h-[4rem] bg-[#C33062] text-[#fff] text-3xl rounded-xl font-syne">Yes!😝❤️🥳</button>
                            <button className="w-[7rem] h-[4rem] bg-[#C33062] text-[#fff] text-3xl rounded-xl font-syne">No! 💔</button>
                        </div>
                    </div>
                </div>
        </div>
