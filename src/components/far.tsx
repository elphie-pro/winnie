             ...
             <div className="w-full block lg:max-w-[85rem] md:max-w-[50rem]  mx-auto px-4 xl:pt-[3rem] md:py-6 pb-12 h-screen">
                <div>
                    <ScrollAnimation from={200} to={0}>
                        <Image alt="" src="/Rectangle 34.svg" width={300} height={300} className="w-1/6 absolute xl:mt-[4rem] xl:ml-[58rem]"/>
                    </ScrollAnimation>
                    <ScrollAnimation from={-200} to={0}>
                        <Image alt="" src="/Rectangle 35.svg" width={10} height={10} className="w-1/6 absolute xl:mt-[28rem] xl:ml-[-1rem] rotate-355"/>
                    </ScrollAnimation>
                </div>
